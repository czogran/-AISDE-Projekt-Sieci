...
int rysuj_graf_sciezka_steiner(vector <Wezel> wezly, vector <Krawendz> krawedzie, Sciezka sciezka)
{
	sf::RenderWindow okno(sf::VideoMode(800, 700, 32), "Network Optimizer");
	sf::Font font;
	font.loadFromFile("arial.ttf");
	while (okno.isOpen())
	{
		...
		for (int i = 0; i < sciezka.krawendzie.size(); i++)
		{
			
			sf::Vertex vertex1(sf::Vector2f(wezly[sciezka.krawendzie[i].wezel_a - 1].x * 5, wezly[sciezka.krawendzie[i].wezel_a - 1].y * 5), sf::Color::Red);
			sf::Vertex vertex2(sf::Vector2f(wezly[sciezka.krawendzie[i].wezel_b - 1].x * 5, wezly[sciezka.krawendzie[i].wezel_b - 1].y * 5), sf::Color::Red);
			sf::Vertex line[2] = { vertex1, vertex2 };
...
int rysuj_graf_sciezka(vector <Wezel> wezly, vector <Krawendz> krawedzie, Sciezka sciezka)
{
	...
	while (okno.isOpen())
	{
		...
		for (int i = 0; i < sciezka.wezly.size() - 1; i++)
		{
			sf::Vertex vertex1(sf::Vector2f(sciezka.wezly[i].x * 5, sciezka.wezly[i].y * 5), sf::Color::Green);
			sf::Vertex vertex2(sf::Vector2f(sciezka.wezly[i + 1].x * 5, sciezka.wezly[i + 1].y * 5), sf::Color::Red);
			sf::Vertex line[2] = { vertex1, vertex2 };
...
int rysuj_graf_sciezka_kruskal(vector <Wezel> wezly, vector <Krawendz> krawedzie, Sciezka sciezka)
{
	sf::RenderWindow okno(sf::VideoMode(800, 700, 32), "Network Optimizer");
	sf::Font font;
	font.loadFromFile("arial.ttf");
